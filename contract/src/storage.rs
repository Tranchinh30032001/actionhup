...
impl StorageManagement for Contract {
    ...
    fn storage_deposit(
        ...
        // todo check fungible token
        // todo! check multiple ft
        if self.is_registered_account(&account_id, &CategoryToken::Vin) {
        ...
        // Register the account and refund any excess $NEAR
            ...
            // todo : multiple fungible token
            self.internal_register_account(&account_id, &CategoryToken::Vin);
            // Perform a refund
